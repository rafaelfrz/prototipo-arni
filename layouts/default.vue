    ...
    return {
      ...
      items: [
        ...
        },
        {
          icon: 'mdi-school',
          title: 'Cursos',
          to: '/administrativo/cursos'
        },
        {
          icon: 'mdi-flag',
          title: 'Países',
          to: '/administrativo/paises'
        }
      ],
      title: 'Protótipo ARNI'
    }
  }
}
</script>
